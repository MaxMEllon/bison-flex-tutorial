...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MUL = 6,                        /* MUL  */
  YYSYMBOL_DIV = 7,                        /* DIV  */
  YYSYMBOL_LITERAL_INT = 8,                /* LITERAL_INT  */
  YYSYMBOL_EOT = 9,                        /* EOT  */
  YYSYMBOL_10_ = 10,                       /* '+'  */
  YYSYMBOL_11_ = 11,                       /* '-'  */
  YYSYMBOL_12_ = 12,                       /* '*'  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "CR", "ADD", "SUB",
  "MUL", "DIV", "LITERAL_INT", "EOT", "'+'", "'-'", "'*'", "'/'",
